...
public class BranchHospital {
	...
	private String fileNameOut = "generatedScript//HBranchInsertion.sql";
	...
	public BranchHospital(int stardId) {
	...
	public void generateScript() throws IOException {
		...
		for (Row row : sheet) {
			...
			paramtersEnglish += "values ( 0 ," + startId +","+ placeTybe + " , null ,  null , "+foreignKeyId+" ,null ,null ,'Giza' ,'Dokki', ";
			startId++;
			paramtersArabic += "values ( 1 ," + startId +","+ placeTybe + " , null ,  null , "+foreignKeyId+" ,null ,null ,N'الجيزة' ,N'الدقي' ,  ";
			startId++;
