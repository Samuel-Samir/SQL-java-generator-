...
public class BranchLab {


	private int startId;
	private String fileNameRead = "files//branchdata.xls";
	private String fileNameOut = "generatedScript//LabBranchInsertion.sql";
	...
	public void generateScript() throws IOException {
		...
		for (Row row : sheet) {
			...
			paramtersEnglish += "values ( 0 ," + startId +","+ placeTybe + " , null ,  null , null , "+foreignKeyId+" ,null ,'Giza' ,'Dokki', ";
			startId++;
			paramtersArabic += "values ( 1 ," + startId +","+ placeTybe + " , null ,  null , null , "+foreignKeyId+" ,null ,N'الجيزة' ,N'الدقي' ,  ";
			startId++;
