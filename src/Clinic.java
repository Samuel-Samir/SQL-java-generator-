...
public class Clinic {
	...
	private int startId;
	private String fileNameRead = "files//clinicdata.xls";
	private String fileNameOut = "generatedScript//ClinicInsertion.sql";
	private ArrayList<String> resultArrayList;

	public Clinic(int stardId) {
	...
	public void generateScript() throws IOException {
		...
		String setIdentityOn = "SET IDENTITY_INSERT clinic ON";
		String setIdentityOff = "SET IDENTITY_INSERT clinic OFF";
		String query = "insert into clinic (clinicId ,clinicNameEN,clinicNameAR,clinicSpecializationEN,clinicSpecializationAR ) ";
		String paramters = "";
