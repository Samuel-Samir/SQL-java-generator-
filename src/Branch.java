...
public class Branch {
	...
	private String fileNameOut = "generatedScript//BranchInsertion.sql";
	...
	public void generateScript() throws IOException {
		...
		for (Row row : sheet) {
			...
			paramtersEnglish += "values ( 0 ," + startId +","+ placeTybe + " , null , " + foreignKeyId	+ " , null , null ,null ,'Giza' ,'Dokki', ";
			startId++;
			paramtersArabic += "values ( 1 ," + startId +","+ placeTybe + " , null , " + foreignKeyId	+ " , null , null ,null ,N'الجيزة' ,N'الدقي' ,  ";
			startId++;

			System.out.println(foreignKeyId);
			for (Cell cell : row) {
